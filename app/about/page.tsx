  ...
  return (
    <CenterLayout>
      <article>
        ...
        />
        <p>
          Hello, my name is Dean and I'm a software engineer based in San
        ...
        <p>
          ...
          Throughout my career, I've developed a passion for using technology to
          solve complex problems and create beautiful, performant user
          interfaces.
        </p>
        <p>
          What sets me apart as a software engineer is my ability to approach
          technical challenges from both a technical and design perspective. I'm
          always looking for new and innovative ways to solve problems and
          create delightful user experiences.
        </p>
        <p>
          Outside of work, I enjoy exploring the great outdoors through hiking,
          camping, and road trips. I'm always up for an adventure and love
