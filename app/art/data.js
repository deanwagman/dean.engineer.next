...
const data = {
  ...
  images: [
    ...
    { src: carwash, name: "Carwash" },
    { src: colorPalette, name: "Color Palette" },
    { src: cyberParking, name: "Cyber Parking" },
    { src: cyberTextures, name: "Cyber Textures" },
    { src: cyber, name: "Cyber" },
    {
      src: dolores,
      name: "Dolores",
    ...
    { src: dolphinOnWheels, name: "Dolphin on Wheels" },
    { src: ghost, name: "Ghost" },
    { src: glitch, name: "Glich" },
    { src: grid, name: "Grid" },
    { src: grudge, name: "Grudge" },
    {
      src: hair,
      name: "Hair",
    ...
    { src: hikingChippy, name: "Hiking Chippy" },
    { src: letterD, name: "Letter D" },
    { src: letterD2, name: "Letter D2" },
    { src: logo, name: "Logo" },
    { src: monolith, name: "Monolith" },
    { src: musterExploration, name: "Muster Exploration" },
    { src: musterExpolration2, name: "Muster Exploration 2" },
    { src: musterExploration3, name: "Muster Exploration 3" },
    { src: nature, name: "Nature" },
    { src: oldGas, name: "Old Gas" },
    { src: palm, name: "Palm" },
    { src: portrait, name: "Portrait" },
    { src: solar, name: "Solar" },
    { src: solar2, name: "Solar 2" },
    { src: toxic, name: "Toxic" },
    { src: weather, name: "Weather" },
    { src: web1, name: "Web 1" },
    { src: web2, name: "Web 2" },
    { src: web3, name: "Web 3" },
    { src: web4, name: "Web 4" },
    { src: zoobooks, name: "Zoobooks" },
  ],
};
