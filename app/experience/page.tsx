        ...
        <article>
          ...
          <ul>
            <li>
              ...
              full-stack application designed for manufacturing teams to track
              and log details of Battery Units throughout their pre-delivery
              lifecycle. This project involved direct engagement with
              stakeholders to gather requirements, challenge assumptions, and
              refine core features. Successfully migrated teams from disparate
              spreadsheets to a unified platform deployed on AWS, enabling
            ...
            <li>
              ...
              manage various resources such as Battery Units, Rental
          ...
          <ul>
            ...
            <li>
              Implemented appointment management features for sales associates
              to check-in, follow-up, edit, and delete appointments
            </li>
          ...
          <ul>
            ...
            <li>
              Collaborated with creative, strategy, and marketing teams to
              develop products that align with business goals
            </li>
          </ul>
